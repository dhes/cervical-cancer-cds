...
For a formal analysis of how the CQL implementation relates to the WHO guideline text, including every interpretive decision made during implementation, see the [Decision Modeling](methodology.md) section.
