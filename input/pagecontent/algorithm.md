...
This IG implements Algorithm 5 from the WHO cervical cancer screening guideline.
It applies to both the general population and women living with HIV (WLHIV),
with population-specific parameters at each decision point.
...
Women living with HIV require two consecutive negative HPV retests at 12-month
